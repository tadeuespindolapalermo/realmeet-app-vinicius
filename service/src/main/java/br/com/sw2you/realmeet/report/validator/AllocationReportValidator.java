...
import static br.com.sw2you.realmeet.util.Constants.ALLOCATIONS_REPORT_MAX_MONTHS_INTERVAL;
...
public class AllocationReportValidator extends AbstractReportValidator {
    ...
    public AllocationReportValidator(@Value(ALLOCATIONS_REPORT_MAX_MONTHS_INTERVAL) int maxMonthInterval) {
    ...
    protected void validate(AbstractReportData reportData, ValidationErrors validationErrors) {
        var allocationReportData = (AllocationDataReport) reportData;
