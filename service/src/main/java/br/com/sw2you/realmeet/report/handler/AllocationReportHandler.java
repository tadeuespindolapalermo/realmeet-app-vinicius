...
@Component
public class AllocationReportHandler extends AbstractReportHandler<Allocation, AllocationDataReport> {
    ...
    @Override
    protected void fillReportParams(HashMap<String, Object> reportParams, AllocationDataReport reportData) {
    ...
    @Override
    protected List<Allocation> fetchReportData(AllocationDataReport reportData) {
