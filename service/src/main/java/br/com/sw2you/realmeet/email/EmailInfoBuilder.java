...
public class EmailInfoBuilder {
    ...
    public EmailInfo createdEmailInfo(String email, TemplateType templateType, Map<String, Object> templateData) {
        return createdEmailInfo(email, templateType, templateData, null);
    }

    public EmailInfo createdEmailInfo(
        String email,
